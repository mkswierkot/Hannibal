...
module.exports = ".mat-form-field {\r\n  padding: 10px;\r\n  color: white;\r\n}\r\n.client-info\r\n{\r\n  background-color:#25282f;\r\n  padding:10px;\r\n  margin-top:20px;\r\n  color:#9d9c9c;\r\n  border-radius:5px;\r\n  text-transform:uppercase;\r\n  font-size:20px;\r\n\r\n}\r\n.add-info\r\n{\r\n  color: indianred;\r\n}\r\ntable{\r\n   border-bottom:1px solid darkgoldenrod;\r\n   border-radius:5px;\r\n   background-color:#222a31;\r\n }\r\n#subscriptionInput {\r\n  width: 250px;\r\n}\r\n#IncomeDate{\r\n  width:250px;\r\n}\r\nform{\r\n   width:100%;\r\n  margin-top:30px;\r\n}\r\nh5 {\r\n  margin-left: 15px;\r\n  margin-bottom: 15px;\r\n  margin-top: 10px;\r\n  color: papayawhip;\r\n}\r\n \r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
    ...
    SectionAddTrainingEntryComponent.prototype.GetClientById = function (clientId) {
        ...
        this.clientService.getClientById(clientId).subscribe(function (clientData) {
            ...
            if (_this.object['gymEntriesLeft'] == 0 && _this.object['martialArtsEntriesLeft'] == 0) {
                ...
                _this.cardMessage = " - WYKORZYSTANO LIMIT WEJŚĆ";
            }
            else if (_this.object['subscriptionExpires'] < _this.today) {
                _this.object['SubscriptionExpired'] = 0;
                _this.cardMessage = _this.cardMessage + " - UPŁYNĄŁ TERMIN WAŻNOŚCI";
            }
            else if (_this.object['subscriptionExpires'].getTime() - _this.today.getTime() <= 604800000) {
                _this.object['SubscriptionExpired'] = 2;
                _this.cardMessage = "KARNET WAŻNY - ZBLIŻA SIĘ TERMIN WAŻNOŚCI, POZOSTAŁO " + Math.round((_this.object['subscriptionExpires'].getTime() - _this.today.getTime()) / 86400000) + " DNI";
            }
