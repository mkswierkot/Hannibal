...
namespace AuctorAPI.Migrations
{
    ...
    [Migration("20191109095840_GroupContracts5")]
    partial class GroupContracts5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuctorAPI.Models.Client", b =>
                {
                    ...
                    b.Property<DateTime?>("Group1Expiry");

                    b.Property<int?>("Group1Id");

                    b.Property<DateTime?>("Group2Expiry");

                    b.Property<int?>("Group2Id");

                    b.Property<DateTime?>("GroupExpiry");
            ...
            modelBuilder.Entity("AuctorAPI.Models.Client", b =>
                {
                    b.HasOne("AuctorAPI.Models.Group", "Group1")
                        .WithMany()
                        .HasForeignKey("Group1Id");

                    b.HasOne("AuctorAPI.Models.Group", "Group2")
                        .WithMany()
